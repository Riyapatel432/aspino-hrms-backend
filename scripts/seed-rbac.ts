...
async function seedRBAC() {
  ...
  try {
    ...
    const permissions = [
      ...
      { app: 'HRMS', module: 'leave', action: 'update', name: 'Edit Leave Masters', desc: 'Update leave configurations' },
      { app: 'HRMS', module: 'leave', action: 'delete', name: 'Delete Leave Masters', desc: 'Remove leave policies' },
